...
def get_features_expectations(validator):
    ...
    ex2 = None # validator.expect_column_values_to_be_between(column="price", min_value=0, max_value=1, meta={"dimension": "Range"})
    ...
    ex5 = None # validator.expect_column_values_to_be_between(column="item_seq_number", min_value=0, max_value=1, meta={"dimension": "Range"})
    ...
    ex8 = None # validator.expect_column_values_to_be_between(column="image_top_1", min_value=0, max_value=1, meta={"dimension": "Range"})
    ...
    ex11 = None # validator.expect_column_values_to_be_between(column="title_length", min_value=0, max_value=1, meta={"dimension": "Range"})
    ...
    ex14 = None # validator.expect_column_values_to_be_between(column="description_length", min_value=0, max_value=1, meta={"dimension": "Range"})
    ...
    ex17 = None # validator.expect_column_values_to_be_between(column="params_length", min_value=0, max_value=1, meta={"dimension": "Range"})
